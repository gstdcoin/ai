...
|-----------|---------------|------|-----------|
| **Backend** | `gstd-backend-blue:v134` | `/home/ubuntu/backend` | `ubuntu-backend-blue-1` |
| **Frontend** | Next.js 16.1.6 | `/home/ubuntu/frontend` | *nohup process* |
| **Telegram Bot** | `gstd-bot:v26` | `/home/ubuntu/gstdbot` | `gstd-telegram-bot` |
