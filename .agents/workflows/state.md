...
│                 OS: Ubuntu 24.04                            │
│                 Last Update: 2026-03-24 (Production v193/v27)       │
├─────────────────────────────────────────────────────────────┤
│                                                             │
...
│  │  Image:      gstd-backend-blue:v193                │     │
│  │  Port:       8080 (internal, via nginx)            │     │
│  │  DB:         distributed_computing                 │     │
│  │  Rollback:   gstd-backend-blue:v192                │     │
│  └────────────────────────────────────────────────────┘     │
│                                                             │
...
|-----------|---------------|------|-----------|
| **Backend** | `gstd-backend-blue:v193` ×4 | `/home/ubuntu/backend` | `ubuntu-backend-blue-{1,2,6,7}` |
