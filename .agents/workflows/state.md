...
|-----------|---------------|------|-----------|
| **Backend** | `gstd-backend-blue:v166` ×4 | `/home/ubuntu/backend` | `ubuntu-backend-blue-{1..4}` |
| **Frontend** | `gstd-frontend:v15` (Docker) | `/home/ubuntu/frontend` | `ubuntu-frontend-1` |
| **Telegram Bot** | `gstd-bot:v28` | `/home/ubuntu/gstdbot` | `gstd-telegram-bot` |
