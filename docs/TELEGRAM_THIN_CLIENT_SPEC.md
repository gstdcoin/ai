# GSTD Telegram — Personal AI + Miner + Mini-node

**Дата:** 11 февраля 2026  
**Цель:** Telegram-бот как персональный AI-ассистент, майнер и мини-нода. Полный функционал, авторизация через кошелёк.
