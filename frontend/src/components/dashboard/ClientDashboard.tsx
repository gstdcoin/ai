...
export const ClientDashboard: React.FC = () => {
    ...
    const [selectedTab, setSelectedTab] = useState<'overview' | 'tasks' | 'escrow'>('overview');

    const fetchData = useCallback(async () => {
        if (!address) return;

        try {
            const [statsData, tasksData, escrowData] = await Promise.all([
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-gradient-to-br from-blue-900/30 to-blue-800/20 rounded-2xl p-5 border border-blue-500/30">
                ...
                <div className="bg-gradient-to-br from-green-900/30 to-green-800/20 rounded-2xl p-5 border border-green-500/30">
                    <div className="flex items-center space-x-3 mb-3">
                ...
                <div className="bg-gradient-to-br from-purple-900/30 to-purple-800/20 rounded-2xl p-5 border border-purple-500/30">
                    <div className="flex items-center space-x-3 mb-3">
                ...
                <div className="bg-gradient-to-br from-orange-900/30 to-orange-800/20 rounded-2xl p-5 border border-orange-500/30">
                    <div className="flex items-center space-x-3 mb-3">
            ...
            <div className="flex space-x-2 border-b border-gray-700 pb-2">
                {(['overview', 'tasks', 'escrow'] as const).map((tab) => (
                    <button
                        key={tab}
