  ...
  return (
    <div className="min-h-screen bg-[#030014] text-white">
      ...
      <header className="py-3 px-6 border-b border-white/5 backdrop-blur-xl bg-black/20">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <a href="/" className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-500 font-medium">/ {t('stats') || 'Network Stats'}</span>
          </a>
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        <h1 className="text-2xl font-black mb-6 tracking-tight">{t('public_dash_title') || 'GSTD Network — Live Dashboard'}</h1>
        ...
        <div className="p-6 rounded-3xl bg-gradient-to-br from-amber-900/10 via-yellow-900/5 to-transparent border border-amber-500/20 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-black">{t('gold_reserve_title') || 'Golden Reserve'}</h2>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <S label={t('gold_reserve_burned') || 'Total Burned'} value={stats?.recycling?.total_burned?.toFixed(2) || '0'} color="text-red-400" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/8">
            <div className="flex items-center gap-2 mb-3"><Globe className="w-4 h-4 text-cyan-400" /><span className="text-xs font-bold uppercase tracking-wider text-gray-400">Network</span></div>
          ...
          {/* Pipeline */}
          <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/8">
            <div className="flex items-center gap-2 mb-3"><Zap className="w-4 h-4 text-violet-400" /><span className="text-xs font-bold uppercase tracking-wider text-gray-400">Pipeline</span></div>
          ...
          {/* Security */}
          <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/8">
            <div className="flex items-center gap-2 mb-3"><Shield className="w-4 h-4 text-emerald-400" /><span className="text-xs font-bold uppercase tracking-wider text-gray-400">Guardrails</span></div>
          ...
          {/* Federated */}
          <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/8">
            <div className="flex items-center gap-2 mb-3"><Brain className="w-4 h-4 text-fuchsia-400" /><span className="text-xs font-bold uppercase tracking-wider text-gray-400">Federated Learning</span></div>
          ...
          {/* Mobile */}
          <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/8">
            <div className="flex items-center gap-2 mb-3"><Server className="w-4 h-4 text-blue-400" /><span className="text-xs font-bold uppercase tracking-wider text-gray-400">Mobile Mining</span></div>
          ...
          {/* OpenClaw */}
          <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/8">
            <div className="flex items-center gap-2 mb-3"><Bot className="w-4 h-4 text-amber-400" /><span className="text-xs font-bold uppercase tracking-wider text-gray-400">OpenClaw Robots</span></div>
        ...
        <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/8 mb-6">
          <div className="flex items-center gap-2 mb-3"><Flame className="w-4 h-4 text-orange-400" /><span className="text-xs font-bold uppercase tracking-wider text-gray-400">Token Economy</span></div>
        ...
        {/* Data Airlock */}
        <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/8">
          <div className="flex items-center gap-2 mb-3"><Lock className="w-4 h-4 text-violet-400" /><span className="text-xs font-bold uppercase tracking-wider text-gray-400">Data Airlock</span></div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
