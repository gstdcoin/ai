        ...
        <div className="flex items-center gap-8 py-2 px-4 animate-marquee whitespace-nowrap text-[11px] font-mono tracking-wide">
          {[...Array(2)].map((_, rep) => (
            <div key={rep} className="flex items-center gap-8">
              <span className="text-amber-400 font-bold">XAUt Reserve: {goldReserve}</span>
              <span className="text-gray-600">|</span>
              <span className="text-cyan-400">GSTD: ${gstdPrice}</span>
              <span className="text-gray-600">|</span>
              <span className="text-emerald-400">{activeNodes} Nodes Online</span>
              <span className="text-gray-600">|</span>
              <span className="text-violet-400">{totalTasks} Tasks Completed</span>
              <span className="text-gray-600">|</span>
              <span className="text-gray-500">Sovereign AI • Gold-Backed • Decentralized</span>
