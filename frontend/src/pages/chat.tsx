...
export default function ChatPage() {
    ...
    const MODELS = [
        { id: 'auto', name: t('model_auto', 'Auto'), desc: t('sovereign_router', 'Sovereign neural router'), tier: 'sovereign' },
        { id: 'gstd-flash', name: t('model_flash', 'Flash'), desc: t('fast__qwen25coder', 'Fast · qwen2.5-coder'), tier: 'sovereign' },
        { id: 'gstd-pro', name: t('pro', 'Pro'), desc: t('balanced__llama31', 'Balanced · llama3.1'), tier: 'sovereign' },
        { id: 'gstd-ultra', name: t('model_ultra', 'Ultra'), desc: t('deep__deepseekr1', 'Deep · deepseek-r1'), tier: 'sovereign' },
        { id: 'cocoon-auto', name: t('model_cocoon', 'Cocoon TEE'), desc: t('cocoon_desc', 'Confidential GPU compute'), tier: 'tee' },
    ];
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-1.5">
                                                        ...
                                                        {m.tier === 'tee' && (
                                                            <span className="text-[9px] px-1.5 rounded bg-emerald-500/15 text-emerald-400 font-bold">{t('tee', 'TEE')}</span>
                                                        )}
                                                    </div>
